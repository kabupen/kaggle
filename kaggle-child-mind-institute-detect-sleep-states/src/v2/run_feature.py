...
if __name__ == "__main__" : 
    ...
    series_id_list = dataset.df_series["id_map"].unique()
    ...
    df_full_series.to_pickle(f"/ebs03/child-mind-institute-detect-sleep-states/output/features/v2/train_series.pkl")